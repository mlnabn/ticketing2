...
const WelcomeHomeUser = ({ user, onGetStarted }) => {
  return (
    <div className="welcome-card-container min-h-screen flex flex-col items-center justify-center text-white px-4 sm:px-6 relative overflow-hidden">
      ...
      <motion.h2
        ...
        className="text-2xl sm:text-3xl md:text-4xl font-bold text-purple-400 mb-4 text-center relative z-10"
      >
      ...
      <motion.p
        ...
        className="text-sm sm:text-base md:text-lg text-gray-300 text-center max-w-2xl mb-10 relative z-10"
      >
      ...
      >
        ...
        <div className="relative z-10 space-y-5">
          ...
          <motion.button
            ...
            className="mt-6 px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 
      ...
      {/* Footer */}
      <footer className="w-full text-center py-6 border-t border-gray-800 text-gray-500 text-xs sm:text-sm mt-10 relative z-10">
