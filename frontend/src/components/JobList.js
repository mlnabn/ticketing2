    ...
    <>
      ...
      >
        ...
        <AnimatePresence>
          ...
          {ticketToDelete &&
            <ConfirmationModal
              key="confirmDeleteModal" // <-- Beri key unik
